...
{
    public interface IRepoArhiva
    {
        IEnumerable<OznakaTelefona> SveOznakeTelefona { get; set; }

        IEnumerable<OznakaMaila> SveOznakeMaila { get; set; }

        IEnumerable<OznakaPostanskeAdrese> SveOznakePostanskeAdrese { get; set; }
